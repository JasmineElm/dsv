...
- _Personalized Marketing_: Retailers like Amazon and Netflix use data science
  ...
  increased sales.
- _Inventory Management_: By analyzing sales data and predicting demand,
...
- _Predictive Maintenance_: By analyzing equipment data, manufacturers can
...
- _Drug Discovery_: Data science accelerates drug discovery by analyzing vast
...
<!-- TODO: split out data Literacy into its own section? -->
